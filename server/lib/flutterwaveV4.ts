...
export function encryptAesGcm(plainText: string, nonce: string): string {
...
export function buildEncryptedCardPayload(card: {
  number: string;
  expiryMonth: string;
  expiryYear: string;
  cvv: string;
...
export async function completeSandboxCharge(chargeId: string): Promise<{
  charge: any;
